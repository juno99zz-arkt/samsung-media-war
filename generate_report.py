...
SAMSUNG_SIGNALS = [
    ...
    '산업붕괴','산업 붕괴','쟁의금지','핵심시설 보호',
    '가처분 인용','가처분 일부 인용','파업은 권리지만','권리지만 안 된다',
    '헛소리','말도 안 돼',
...
UNION_SIGNALS = [
    ...
    '파업권 보장','파업권 탄압','파업권 침해','파업 권리 보장','헌법상 권리','헌법적 권리',
